...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Drip.description'
        db.add_column('drip_drip', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Drip.template_name'
        db.add_column('drip_drip', 'template_name',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Drip.drip_class'
        db.add_column('drip_drip', 'drip_class',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Drip.description'
        db.delete_column('drip_drip', 'description')

        # Deleting field 'Drip.template_name'
        db.delete_column('drip_drip', 'template_name')

        # Deleting field 'Drip.drip_class'
        db.delete_column('drip_drip', 'drip_class')
    ...
    models = {
        ...
        'drip.drip': {
            ...
            'drip_class': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '120', 'blank': 'True'}),
            ...
            'template_name': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'})
        },
        'drip.querysetrule': {
